...
export const blogController = {
  async home(req: Request, res: Response) {
    ...
    res.render("blog/home", {
      ...
      title: "Beranda",
      meta: {
        title: "Panduandoa | Panduan Doa dan Ibadah Harian Modern",
        description:
          "Artikel islami modern tentang doa harian, dzikir pagi petang, panduan ibadah, dan bacaan sholat yang nyaman dibaca.",
  ...
  async showPost(req: Request, res: Response) {
    ...
    const related = await postRepository.related(
      post.id,
      post.postCategories.map((item: { categoryId: string }) => item.categoryId),
      post.postTags.map((item: { tagId: string }) => item.tagId)
    );
    ...
    const replyTarget = replyTo
      ? post.comments.find((comment: { id: string }) => comment.id === replyTo) ?? null
      : null;
  ...
  async category(req: Request, res: Response) {
    ...
    res.render("blog/archive", {
      ...
      title: category.name,
      meta: {
        title: `${category.name} | Panduandoa`,
        description: `Kumpulan artikel ${category.name.toLowerCase()} yang nyaman dibaca dan relevan untuk panduan doa harian.`,
  ...
  async tag(req: Request, res: Response) {
    ...
    res.render("blog/archive", {
      ...
      title: tag.name,
      meta: {
        title: `${tag.name} | Panduandoa`,
        description: `Artikel dengan tag ${tag.name.toLowerCase()} yang relevan untuk dzikir, doa, dan panduan ibadah.`,
  ...
  async search(req: Request, res: Response) {
    ...
    res.render("blog/search", {
      ...
      title: q ? `Cari: ${q}` : "Cari",
      meta: {
        title: q ? `Cari: ${q} | Panduandoa` : "Cari | Panduandoa",
        description: "Cari artikel islami berdasarkan doa harian, dzikir, panduan ibadah, dan bacaan sholat.",
